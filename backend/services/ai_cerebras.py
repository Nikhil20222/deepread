...
def generate_summary_cerebras(text, mode="detailed"):
...
def generate_flashcards_cerebras(text):
...
def generate_quiz_cerebras(text):
...
def generate_mindmap_cerebras(text):
...
def generate_section_summary_cerebras(text):
...
def generate_chat_answer_cerebras(text, question, history=None):
